...
public class chapter32GeoPoint {
    // 실수 변수
    static double latitude1 = 37.52127220511242;
    static double longitude1 = 127.0074462890625;  // 서울
    static double latitude2 = 35.137879119634185;
    static double longitude2 = 129.04541015625;    // 부산
